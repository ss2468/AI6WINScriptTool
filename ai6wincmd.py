...
parser = argparse.ArgumentParser(prog="AI6WINScriptTool", description="Assembler and disassembler of AI6WIN enginescripts")
...
parser.add_argument('-v', '--version', dest="version", choices=[0, 1], default=1, required=False, type=int, help="Mes version")
